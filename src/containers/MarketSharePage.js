...
const project_info_1 = [
    {
        title: "My Role",
        description: <Fragment><p>I played the role of project manager and main developer. It with a conversation with our Marketing Manager who wanted to revamp these pages. Due to other features being ahead in the Product pipeline, it was not a high priority. I sat down with him and our VP of Product to create an overall vision of what we wanted to accomplish. We came up with a game plan to introduce more graphs, improve the overall user flow, and create stronger CTAs.</p></Fragment>
    }
]
